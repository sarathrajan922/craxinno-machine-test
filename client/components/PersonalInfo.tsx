      ...
      <div className="text-black flex mt-10 flex-col gap-3 w-96">
        ...
        <div className="relative w-full min-w-[420px] h-12 flex gap-2 mt-5">
          <div className="relative h-12 w-20 min-w-[100px]">
            <select className="peer text-gray-400 h-full w-full rounded-[7px] border   bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-100 outline outline-0 transition-all  placeholder-shown:border-blue-gray-200  empty:!bg-gray-200 focus:border-2 focus:border-gray-300  focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
