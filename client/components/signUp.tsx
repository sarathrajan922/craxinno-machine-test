  ...
  return (
    <>
      <div className="text-black flex mt-10 flex-col gap-3 w-96">
        ...
        <p className="items-center text-sm mt-0 text-gray-400 font-medium">
          set-up your RentlyPass in as little as 2 minutes.
        </p>

        <h3 className="text-gray-500 text-bold">Contact Details</h3>
        <div className="relative w-full min-w-[420px] h-12  mt-5">
          <input
